...
def __create_embed_tables(embed: discord.Embed, tables: list[Union[table_name, table_description, table_inline, table_subtables]]):
    ...
    try:
        for object in tables: # Espaciado entre columnas
            ...
            if len(object) > 3:
                __create_embed_tables(embed, object[3])
...
def create_embed(em_title: str, em_description: str, em_color: discord.Color = None, author: tuple[str, image_url] = None, footer: tuple[str, image_url] = None, tables: list[tuple[Union[table_name, table_description, table_inline, table_subtables]]] = None, image: image_url = None, thumbnail: image_url = None, em_timestamp: datetime.datetime = None):
    ...
    if tables != None:
        __create_embed_tables(Embed, tables)
